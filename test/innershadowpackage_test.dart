...
import 'package:inner_shadow/src/inner_shadow_decoration.dart';
...
void main() {
  group('InnerShadow Widget Tests', () {
    ...
    testWidgets('renders with BorderRadius', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: InnerShadow(
            shadows: const [
              Shadow(color: Colors.black26, blurRadius: 8, offset: Offset(3, 3)),
            ],
    ...
    testWidgets('InnerShadowContainer renders correctly', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
